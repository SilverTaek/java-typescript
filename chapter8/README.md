...
8장을 보면서 모던 자바스크립트로 작성, ECMAScript 모듈 사용하기, var 대신 let/const 사용하기, 저수준 프로미스나 콜백 대신 async/await 사용하기, 함수 표현식보다 화살표 함수 사용하기 등 코드를 작성함에 있어 기본적으로 사용하고 있었던 방법, 방식에 대해서 다시 한번 생각해보게 되었습니다. 현재 코드를 작성하는 방식에 대해서 다시 한번 점검이 필요해 보입니다.
