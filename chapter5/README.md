...
## 강현구
any 타입을 적재적소에 활용하는 방법에 대해 알게 되었고, 5장을 관통하는 주제는 any 타입은 지양하며 좁은 범위에서 사용 할 것을 권장하고 있습니다.
js -> ts 마이그레이션 외에 특별히 any 타입을 사용할 일이 없을 것으로 생각되는데 
이후 개발 시 사용 될 일이 있더라도 5장에서 봤던 내용을 인지하여 개발에 도움이 될 것으로 생각됩니다.
